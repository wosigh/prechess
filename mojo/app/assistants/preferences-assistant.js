...
////////////////////////////////////////////////////////////////////////////
    ...
    this.controller.setupWidget("MakeToneToggle",{},this.MakeToneToggleModel = { value: PreChess.MakeTone });
    this.controller.setupWidget('DownloadToggle', 
				this.atts = {
...
PreferencesAssistant.prototype.changeMakeTone = function(event) {PreChess.MakeTone = this.MakeToneToggleModel.value;};
PreferencesAssistant.prototype.changeDownload = function(event) {this.question(),this.callDeactivateSpinner();};


PreferencesAssistant.prototype.callDeactivateSpinner = function() {
	if (!this.spinning) {
...
PreferencesAssistant.prototype.deactivateSpinner = function() {
	this.buttonWidget = this.controller.get('DownloadToggle');
	this.buttonWidget.mojo.deactivate();
	this.spinning = false;
}

PreferencesAssistant.prototype.question = function(event) 
{
		...
		Mojo.Controller.stageController.activeScene().showAlertDialog({
					...
					choices:[
						...
						{label:"No", value:false, type:'affirmative'}
					]
				});		
}
...
PreferencesAssistant.prototype.download = function(event) 
{
